...
requireText("matrix", "Can users ask for help without exposing private Codex data?", "privacy-safe support question");
requireText("matrix", "support question template", "support question template proof");
requireText("matrix", "npm run issue-routing:readiness", "issue routing gate");
...
requireText("matrix", "npm run npm:latest", "npm latest gate");
requireText("matrix", "npm run ci:latest", "latest CI gate");
requireText("matrix", "live dist-tag", "live npm latest boundary");
requireText("matrix", "latest public workflow evidence", "latest CI evidence boundary");
