...
requireText("adoption", "docs/adoption-snapshot.md", "adoption snapshot link");
requireText("adoption", "privacy-first maintainer workflows", "privacy-first workflow seed");
requireText("adoption", "support question template", "support question public route");
requireText("adoption", "support question, bug, feature, and integration templates", "typed feedback route");
requireText("adoption", "without sharing private Codex context", "privacy-safe validation route");
requireText("adoption", "npm run submission:check", "submission gate");
requireText("adoption", "npm run adoption:snapshot", "adoption snapshot gate");
