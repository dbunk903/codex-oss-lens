...
requireText("npm run form-answers:check", "form answers gate command");
...
requireText("npm run npm:latest", "npm latest gate command");
requireText("npm run ci:latest", "latest CI gate command");
...
requireText("npm run adoption:snapshot", "adoption snapshot gate command");
...
requireText("npm run scope:limitations", "scope limitations gate command");
...
requireText("npm run submission:rehearsal", "submission rehearsal gate command");
...
requireText("Form answers | Ready", "form answers row");
requireText("application/form-answers.md", "form answers source");
requireText("canonical reviewer link map", "form answers link map");
...
requireText("npm latest registry | Ready", "npm latest registry row");
requireText("live npm registry dist-tag", "npm latest registry behavior");
requireText("Latest CI runs | Ready", "latest CI runs row");
requireText("latest completed Node tests and published smoke workflow runs are green", "latest CI behavior");
...
requireText("support question template", "support question template evidence");
...
requireText("support question route", "issue routing support question evidence");
requireText("Release provenance | Ready", "release provenance row");
requireText("Adoption readiness | Ready", "adoption readiness row");
requireText("Adoption snapshot | Ready", "adoption snapshot row");
...
requireText("Scope and limitations | Ready", "scope limitations row");
