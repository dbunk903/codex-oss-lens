...
requireText("risk", "npm run npm:latest", "npm latest gate");
requireText("risk", "npm run ci:latest", "latest CI gate");
requireText("risk", "red public CI", "latest CI stop condition");
requireText("risk", "live npm latest gate", "live npm latest mitigation");
