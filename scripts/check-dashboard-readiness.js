...
requireText("docs/submitter-handoff.md", "dashboard submitter handoff link");
requireText("Submitter handoff", "dashboard submitter handoff label");
requireText("submitter:handoff", "dashboard submitter handoff gate");
...
requireText("SUPPORT.md", "dashboard support link");
requireText("Support", "dashboard support label");
requireText("support:readiness + issue-routing", "dashboard support and issue routing gate");
