...
requireText("faq", "How can users ask for help safely?", "privacy-safe support question");
requireText("faq", "support question template", "support question template guidance");
requireText("faq", "tokens, credentials, and private repository details", "support sensitive-data boundary");
