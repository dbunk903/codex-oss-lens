...
public-redaction, public evidence sample, public-link, badge, README readiness, unit-test, tarball
dry-run, and packaged CLI smoke gates. It also runs the reviewer quickstart and publish sample
checks:
