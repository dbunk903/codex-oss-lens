...
| Are limits and manual gates clear? | Scope and limitations, submission risk register, submission rehearsal, final checklist, application status | `npm run scope:limitations`, `npm run submission:risk`, `npm run submission:rehearsal`, `npm run application:status` |
