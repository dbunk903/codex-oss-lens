...
| Is the tool relevant to Codex users? | README, maintainer use cases, API-credit workflow, demo walkthrough | `npm run reviewer:quickstart`, `npm run demo:walkthrough` |
...
| Are limits and manual gates clear? | Scope and limitations, submission rehearsal, final checklist, application status | `npm run scope:limitations`, `npm run submission:rehearsal`, `npm run application:status` |
