...
- `publicLinks`: repository, release, npm, roadmap, status, reviewer quickstart, API workflow,
  use cases, final checklist, final copy, public evidence sample, reviewer samples, and CI links
