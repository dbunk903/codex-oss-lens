...
- `publicLinks`: repository, release, npm, roadmap, status, application evidence matrix, reviewer
  quickstart, release provenance, adoption plan, maintenance policy, maintainer handoff, scope and
