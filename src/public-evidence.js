...
export function buildPublicEvidence(options = {}) {
  ...
  const evidence = {
    ...
    proofPoints: [
      ...
      proof("supportPolicy", "Support policy routes public questions through privacy-safe issue templates.", links.supportPolicyUrl),
...
function compactLinks(options) {
  return {
    ...
    ...(options.supportPolicyUrl ? { supportPolicyUrl: options.supportPolicyUrl } : {}),
