...
export function buildPublicEvidence(options = {}) {
  ...
  const evidence = {
    ...
    proofPoints: [
      ...
      proof("dashboardPreview", "Desktop dashboard preview shows the reviewer-facing UI.", links.dashboardPreviewUrl),
      proof("mobileDashboardPreview", "Mobile dashboard preview shows responsive reviewer-facing UI.", links.mobileDashboardPreviewUrl),
