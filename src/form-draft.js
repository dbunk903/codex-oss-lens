export function buildFormDraft({ manifest, readiness, apiPlan, scorecard, links = {} } = {}) {
  ...
  const draft = {
    ...
    publicLinks: {
      ...
      applicationEvidenceMatrix: links.applicationEvidenceMatrixUrl || "",
      applicationReviewFaq: links.applicationReviewFaqUrl || "",
      submissionRiskRegister: links.submissionRiskRegisterUrl || "",
      submissionDecisionSummary: links.submissionDecisionSummaryUrl || "",
      submissionActivityLog: links.submissionActivityLogUrl || "",
      reviewerQuickstart: links.reviewerQuickstartUrl || "",
      signedOutReview: links.signedOutReviewUrl || "",
      releaseProvenance: links.releaseProvenanceUrl || "",
      adoptionPlan: links.adoptionPlanUrl || "",
      adoptionSnapshot: links.adoptionSnapshotUrl || "",
      maintenancePolicy: links.maintenancePolicyUrl || "",
      supportPolicy: links.supportPolicyUrl || "",
      maintainerHandoff: links.maintainerHandoffUrl || "",
      scopeLimitations: links.scopeLimitationsUrl || "",
      privacyThreatModel: links.privacyThreatModelUrl || "",
      dataRetention: links.dataRetentionUrl || "",
      demoWalkthrough: links.demoWalkthroughUrl || "",
      accessibility: links.accessibilityUrl || "",
      apiCreditWorkflow: links.apiWorkflowUrl || "",
      maintainerUseCases: links.useCasesUrl || "",
      finalChecklist: links.finalChecklistUrl || "",
      submissionRehearsal: links.submissionRehearsalUrl || "",
...
const PUBLIC_LINK_LABELS = {
  ...
  applicationEvidenceMatrix: "Application evidence matrix",
  applicationReviewFaq: "Application review FAQ",
  submissionRiskRegister: "Submission risk register",
  submissionDecisionSummary: "Submission decision summary",
  submissionActivityLog: "Submission activity log",
  reviewerQuickstart: "Reviewer quickstart",
  signedOutReview: "Signed-out review checklist",
  ...
  maintainerHandoff: "Maintainer handoff",
  scopeLimitations: "Scope and limitations",
  privacyThreatModel: "Privacy threat model",
  ...
  submissionRehearsal: "Submission rehearsal",
