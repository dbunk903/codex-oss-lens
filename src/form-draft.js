...
function renderFormDraftMarkdown(draft) {
  return [
    ...
    "## Public Links",
    "",
    `- Repository: ${draft.publicLinks.repository || "TODO"}`,
    `- Latest release: ${draft.publicLinks.latestRelease || "TODO"}`,
    `- Roadmap: ${draft.publicLinks.roadmap || "TODO"}`,
    `- API credit workflow: ${draft.publicLinks.apiCreditWorkflow || "TODO"}`,
    "",
    "## Repository Fit",
    "",
