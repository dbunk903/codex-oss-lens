  ...
  if (command === "form-draft") {
    ...
    const draft = buildFormDraft({
      ...
      links: {
        ...
        adoptionSnapshotUrl: options.adoptionSnapshotUrl,
        maintenancePolicyUrl: options.maintenancePolicyUrl,
        supportPolicyUrl: options.supportPolicyUrl,
...
function parseArgs(args) {
  ...
  for (let i = 0; i < args.length; i += 1) {
    ...
    else if (arg === "--adoption-snapshot-url") options.adoptionSnapshotUrl = args[++i];
    else if (arg === "--maintenance-policy-url") options.maintenancePolicyUrl = args[++i];
    else if (arg === "--support-policy-url") options.supportPolicyUrl = args[++i];
