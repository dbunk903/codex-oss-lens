...
5. Create an initial release `v0.1.0`. Done. Follow-up releases `v0.2.0` and `v0.3.0` also published.
6. Open 3 starter issues. Done. Issues #1 through #5 were implemented and closed.
