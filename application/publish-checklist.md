...
- `submission:check`, `application:evidence`, `publish:samples`, `support:readiness`, `conduct:readiness`,
  ...
  `readme:readiness` keep the public application, evidence matrix, publish, support, conduct, license, issue
