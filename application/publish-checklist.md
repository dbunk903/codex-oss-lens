...
5. Create an initial release `v0.1.0`. Done. Follow-up releases through `v0.6.0` also published.
6. Open 3 starter issues. Done. Issues #1 through #10 were implemented and closed.
