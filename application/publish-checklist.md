...
- `submission:check`, `application:evidence`, `reviewer:faq`, `submission:risk`, `submission:decision`, `publish:samples`, `support:readiness`, `conduct:readiness`,
  ...
  submission rehearsal, decision summary, and README guidance aligned before
