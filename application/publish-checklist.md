...
5. Create an initial release `v0.1.0`. Done. Follow-up releases through `v1.4.0` also published.
6. Open 3 starter issues. Done. Issues #1 through #10, #12, and #14 through #23 were implemented and closed.
