...
- `submission:check`, `application:evidence`, `reviewer:faq`, `publish:samples`, `support:readiness`, `conduct:readiness`,
  ...
  `readme:readiness` keep the public application, evidence matrix, review FAQ, publish, support, conduct, license, issue
