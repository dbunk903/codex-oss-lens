...
6. Open 3 starter issues. Done. Issues #1 through #12 and #14 through #27 were implemented and closed except #13.
...
- npm publish completed for `codex-oss-lens@1.6.0`; `v1.6.1` verifies published install smoke from an isolated temporary directory.
