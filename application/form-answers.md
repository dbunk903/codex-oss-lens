...
- Latest release: https://github.com/dbunk903/codex-oss-lens/releases/tag/v0.4.0
...
- Closed issues: #1, #2, #3, #4, #5, #6, #7
- Open development issues: next UI/API integration issues after v0.4.0
...
현재 v0.4.0 공개 릴리스가 있습니다. 의존성 없는 Node CLI와 정적 UI로 구성되어 있고, quota/token 분석, 주간 리포트, Git branch/commit 연결, workflow 분류, API dry-run payload, GitHub issue/PR import를 제공합니다. 공개 issues #1-#7을 처리해 유지관리 활동도 남겼습니다.
